...
like where the class is defined and our computer’s memory address where this object is stored, 
but is usually not useful information to have when we are trying to debug our code.
...
print(repr(medium_pizza))
print(repr(teaching_table))
print(repr(round_room))
